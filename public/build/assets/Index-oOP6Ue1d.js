import{c as st,u as rt,r as d,j as e,H as at}from"./app-DxWhSRvS.js";import{A as nt}from"./app-layout-CoywqTIj.js";import{n as ct}from"./notify-C26Uxdsg.js";import Z from"./CartPanel-piI7jgpj.js";import lt,{SuccessModal as dt}from"./PaymentModal-9mhZiWBq.js";import mt from"./ProductGrid-WCFGra_n.js";import pt from"./PosHistory-Dai_gKRd.js";import{f as b}from"./format-Dvu9qd1M.js";import{S as ut}from"./shopping-cart-BBLVJLeo.js";/* empty css            */import"./index-B9bmMW_L.js";import"./loader-circle-tNSmBwDr.js";import"./createLucideIcon-CsSD7-8n.js";import"./triangle-alert-ZXjBZsxO.js";import"./circle-check-BACRIhLD.js";import"./button-Cz8flqMf.js";import"./clsx-B-dksMZM.js";import"./utils-DlhoCQ_R.js";import"./index-_enNvjJz.js";import"./x-RAVHcG5N.js";import"./app-logo-icon-CGItTSVn.js";import"./index-B_e8Ugpt.js";import"./index-CSEUMRIG.js";import"./permissions-BQ2AODNn.js";import"./wallet-B2p4TF5A.js";import"./log-out-B12Rgiyn.js";import"./package-BnLVOMrN.js";import"./index-DDbHu5d-.js";import"./index-B8JM8ua-.js";import"./settings-LqFO-Vb3.js";import"./products-hCxJfRGA.js";import"./apple-Bw9jC-i2.js";import"./pencil-DpzlD9Es.js";import"./minus-D0f3v5Qd.js";import"./plus-aPDzfn3W.js";import"./trash-2-B83CeFiS.js";import"./FormSelect-Bayd_eq2.js";import"./index-DXAtpqJa.js";import"./truck-CDOE-ADt.js";import"./circle-check-big-C8SIFP-h.js";import"./printer-DbnLfl_0.js";import"./use-pagination-CwPr5UbZ.js";import"./search-BYyw6Ebh.js";import"./image-CH3HWVLm.js";import"./search-input-D1cCb1TQ.js";import"./PosDetailModal-CEFdntHP.js";const ft=[{title:"Master Barang",href:"/items"}],le=()=>{const t=st.c(47),{productData:v,posData:S}=rt().props;let w;t[0]!==v?(w=v.map(ht),t[0]=v,t[1]=w):w=t[1];const O=w;console.log("POS Data:",S);const[Q,tt]=d.useState("");let j;t[2]===Symbol.for("react.memo_cache_sentinel")?(j=[],t[2]=j):j=t[2];const[r,y]=d.useState(j),[n,P]=d.useState("tunai"),[H,C]=d.useState(!1),[E,W]=d.useState(!1);let N;t[3]===Symbol.for("react.memo_cache_sentinel")?(N={total:0,cashReceived:0,change:0,charge:0},t[3]=N):N=t[3];const[c,et]=d.useState(N),[L,B]=d.useState(!1),[x,Y]=d.useState("pos");let k;t[4]===Symbol.for("react.memo_cache_sentinel")?(k=i=>{let o=!1;y(a=>{const s=a.find(l=>l.product.id===i.id);return s?s.qty>=i.stock?(o=!0,a):a.map(l=>l.product.id===i.id?{...l,qty:l.qty+1}:l):i.stock<=0?(o=!0,a):[...a,{product:i,qty:1,customPrice:null}]}),o&&ct.error("Stok tidak cukup!")},t[4]=k):k=t[4];const it=k;let _;t[5]===Symbol.for("react.memo_cache_sentinel")?(_=(i,o)=>{y(a=>a.map(s=>{if(s.product.id!==i)return s;const l=s.qty+o;return l<1||l>s.product.stock?s:{...s,qty:l}}))},t[5]=_):_=t[5];const J=_;let $;t[6]===Symbol.for("react.memo_cache_sentinel")?($=i=>{y(o=>o.filter(a=>a.product.id!==i))},t[6]=$):$=t[6];const U=$;let M;t[7]===Symbol.for("react.memo_cache_sentinel")?(M=(i,o)=>{y(a=>a.map(s=>s.product.id===i?{...s,customPrice:o}:s))},t[7]=M):M=t[7];const V=M;let R;t[8]===Symbol.for("react.memo_cache_sentinel")?(R=(i,o,a,s)=>{et({total:s,cashReceived:i,change:o,charge:a}),C(!1),W(!0)},t[8]=R):R=t[8];const ot=R;let z;t[9]===Symbol.for("react.memo_cache_sentinel")?(z=()=>{y([]),W(!1),P("tunai")},t[9]=z):z=t[9];const X=z;let A;t[10]!==r||t[11]!==c||t[12]!==n?(A=()=>{const i=window.open("","_blank","width=400,height=600"),o=new Date,a=`POS-${o.getFullYear()+String(o.getMonth()+1).padStart(2,"0")+String(o.getDate()).padStart(2,"0")+String(o.getHours()).padStart(2,"0")+String(o.getMinutes()).padStart(2,"0")+String(o.getSeconds()).padStart(2,"0")}`;if(!i)return;const s=r.map(gt).join("");i.document.write(`
      <html>
        <head>
            <title>Struk</title>
            <style>
