import{c as st,u as rt,r as d,j as e,H as at}from"./app-BVSDG-fz.js";import{A as nt}from"./app-layout-DXAC_eZU.js";import{n as ct}from"./notify-BPwHGdr2.js";import Z from"./CartPanel-Bt7T2PMK.js";import lt,{SuccessModal as dt}from"./PaymentModal-C7Uf_1LG.js";import mt from"./ProductGrid-Cy4l8skr.js";import pt from"./PosHistory-CvOIzVwr.js";import{f as K}from"./format-Dvu9qd1M.js";import{S as ut}from"./shopping-cart-Bs9V1t4V.js";/* empty css            */import"./index-BIIWG68f.js";import"./loader-circle-D-ODPxjl.js";import"./createLucideIcon-DLgVemOi.js";import"./triangle-alert-CegFrb5T.js";import"./circle-check-DODNpN5s.js";import"./button-RCN7GTN8.js";import"./clsx-B-dksMZM.js";import"./utils-DlhoCQ_R.js";import"./index-BTV6BpMa.js";import"./x-CerRdHk0.js";import"./app-logo-icon-D4Q_gd8T.js";import"./index-B_e8Ugpt.js";import"./index-CSEUMRIG.js";import"./permissions-DEGPC5Rl.js";import"./wallet-CAgHMVCc.js";import"./log-out-Bh8Rmj_L.js";import"./package-37TiQziL.js";import"./index-tZgpwuhb.js";import"./index-UkBAdHR5.js";import"./settings-Bd4b7DDs.js";import"./products-hCxJfRGA.js";import"./apple-bCLI0b9Y.js";import"./pencil-BGIKAsBz.js";import"./minus-BQQjh2Di.js";import"./plus-CRJOQMia.js";import"./trash-2-BKv9zdND.js";import"./FormSelect-C3jt7G-M.js";import"./index-D_IoyYLS.js";import"./truck-Bf-Lkqyn.js";import"./circle-check-big-DyQXAh7S.js";import"./printer-DDQc-yP5.js";import"./use-pagination-C4qELd4u.js";import"./search-DrrG2r0A.js";import"./image-Ww7kK2Vf.js";import"./search-input-DQswl6UM.js";import"./PosDetailModal-0xmJpA4e.js";const ft=[{title:"Master Barang",href:"/items"}],le=()=>{const t=st.c(47),{productData:v,posData:b}=rt().props;let S;t[0]!==v?(S=v.map(ht),t[0]=v,t[1]=S):S=t[1];const O=S;console.log("POS Data:",b);const[Q,tt]=d.useState("");let w;t[2]===Symbol.for("react.memo_cache_sentinel")?(w=[],t[2]=w):w=t[2];const[r,y]=d.useState(w),[n,j]=d.useState("tunai"),[H,P]=d.useState(!1),[L,W]=d.useState(!1);let C;t[3]===Symbol.for("react.memo_cache_sentinel")?(C={total:0,cashReceived:0,change:0,charge:0},t[3]=C):C=t[3];const[c,et]=d.useState(C),[E,I]=d.useState(!1),[x,Y]=d.useState("pos");let N;t[4]===Symbol.for("react.memo_cache_sentinel")?(N=i=>{let o=!1;y(a=>{const s=a.find(l=>l.product.id===i.id);return s?s.qty>=i.stock?(o=!0,a):a.map(l=>l.product.id===i.id?{...l,qty:l.qty+1}:l):i.stock<=0?(o=!0,a):[...a,{product:i,qty:1,customPrice:null}]}),o&&ct.error("Stok tidak cukup!")},t[4]=N):N=t[4];const it=N;let k;t[5]===Symbol.for("react.memo_cache_sentinel")?(k=(i,o)=>{y(a=>a.map(s=>{if(s.product.id!==i)return s;const l=s.qty+o;return l<1||l>s.product.stock?s:{...s,qty:l}}))},t[5]=k):k=t[5];const J=k;let $;t[6]===Symbol.for("react.memo_cache_sentinel")?($=i=>{y(o=>o.filter(a=>a.product.id!==i))},t[6]=$):$=t[6];const U=$;let _;t[7]===Symbol.for("react.memo_cache_sentinel")?(_=(i,o)=>{y(a=>a.map(s=>s.product.id===i?{...s,customPrice:o}:s))},t[7]=_):_=t[7];const V=_;let M;t[8]===Symbol.for("react.memo_cache_sentinel")?(M=(i,o,a,s)=>{et({total:s,cashReceived:i,change:o,charge:a}),P(!1),W(!0)},t[8]=M):M=t[8];const ot=M;let R;t[9]===Symbol.for("react.memo_cache_sentinel")?(R=()=>{y([]),W(!1),j("tunai")},t[9]=R):R=t[9];const X=R;let z;t[10]!==r||t[11]!==c||t[12]!==n?(z=()=>{const i=window.open("","_blank","width=400,height=600"),o=new Date,a=`POS-${o.getFullYear()+String(o.getMonth()+1).padStart(2,"0")+String(o.getDate()).padStart(2,"0")+String(o.getHours()).padStart(2,"0")+String(o.getMinutes()).padStart(2,"0")+String(o.getSeconds()).padStart(2,"0")}`;if(!i)return;const s=r.map(gt).join("");i.document.write(`
      <html>
        <head>
            <title>Struk</title>
            <style>
