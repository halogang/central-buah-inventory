import{c as st,u as rt,r as d,j as e,H as at}from"./app-97dXHZJ3.js";import{A as nt}from"./app-layout-Cehu3BKP.js";import{n as ct}from"./notify-C9MXyypk.js";import Z from"./CartPanel-CwufdR7X.js";import lt,{SuccessModal as dt}from"./PaymentModal-BPoS-Iks.js";import mt from"./ProductGrid-3UT4lTpl.js";import pt from"./PosHistory--aivdpAp.js";import{f as b}from"./format-Dvu9qd1M.js";import{S as ut}from"./shopping-cart-CC7fTgR-.js";/* empty css            */import"./index-BW6Q9EOr.js";import"./loader-circle-CrgqmCEd.js";import"./createLucideIcon-S1Elix0A.js";import"./triangle-alert-IRlx-B-3.js";import"./circle-check-BzijNAc7.js";import"./button-BosQ51U6.js";import"./clsx-B-dksMZM.js";import"./utils-DlhoCQ_R.js";import"./index-Ce3p-mrx.js";import"./x-B8z8qfsA.js";import"./app-logo-icon-B9vHXYZG.js";import"./index-B_e8Ugpt.js";import"./index-CSEUMRIG.js";import"./permissions-BLy-oAv4.js";import"./wallet-CT3yKtI1.js";import"./log-out-DsN_V_Je.js";import"./package-DRbzAbML.js";import"./index-Di_dBHAi.js";import"./index-Cv5mdQoB.js";import"./settings-Cjqda4cI.js";import"./products-hCxJfRGA.js";import"./apple-BbnRUFtk.js";import"./pencil-CldYHp4s.js";import"./minus-D6SnuOsY.js";import"./plus-DX6suSOO.js";import"./trash-2-De3JdTa3.js";import"./FormSelect-BjW0QWq2.js";import"./index-DkmNgXMA.js";import"./truck-BOb3C_Ws.js";import"./circle-check-big-ArAYMQT_.js";import"./printer-BHZzniOl.js";import"./use-pagination-v-vThmYD.js";import"./search-BCI4h7SL.js";import"./image-BPAgTnSk.js";import"./search-input-BBRwBFyg.js";import"./PosDetailModal-pAm0sbtf.js";const ft=[{title:"Master Barang",href:"/items"}],le=()=>{const t=st.c(47),{productData:v,posData:S}=rt().props;let w;t[0]!==v?(w=v.map(ht),t[0]=v,t[1]=w):w=t[1];const O=w;console.log("POS Data:",S);const[Q,tt]=d.useState("");let j;t[2]===Symbol.for("react.memo_cache_sentinel")?(j=[],t[2]=j):j=t[2];const[r,y]=d.useState(j),[n,P]=d.useState("tunai"),[H,C]=d.useState(!1),[E,W]=d.useState(!1);let N;t[3]===Symbol.for("react.memo_cache_sentinel")?(N={total:0,cashReceived:0,change:0,charge:0},t[3]=N):N=t[3];const[c,et]=d.useState(N),[L,B]=d.useState(!1),[x,Y]=d.useState("pos");let k;t[4]===Symbol.for("react.memo_cache_sentinel")?(k=i=>{let o=!1;y(a=>{const s=a.find(l=>l.product.id===i.id);return s?s.qty>=i.stock?(o=!0,a):a.map(l=>l.product.id===i.id?{...l,qty:l.qty+1}:l):i.stock<=0?(o=!0,a):[...a,{product:i,qty:1,customPrice:null}]}),o&&ct.error("Stok tidak cukup!")},t[4]=k):k=t[4];const it=k;let $;t[5]===Symbol.for("react.memo_cache_sentinel")?($=(i,o)=>{y(a=>a.map(s=>{if(s.product.id!==i)return s;const l=s.qty+o;return l<1||l>s.product.stock?s:{...s,qty:l}}))},t[5]=$):$=t[5];const J=$;let _;t[6]===Symbol.for("react.memo_cache_sentinel")?(_=i=>{y(o=>o.filter(a=>a.product.id!==i))},t[6]=_):_=t[6];const U=_;let M;t[7]===Symbol.for("react.memo_cache_sentinel")?(M=(i,o)=>{y(a=>a.map(s=>s.product.id===i?{...s,customPrice:o}:s))},t[7]=M):M=t[7];const V=M;let R;t[8]===Symbol.for("react.memo_cache_sentinel")?(R=(i,o,a,s)=>{et({total:s,cashReceived:i,change:o,charge:a}),C(!1),W(!0)},t[8]=R):R=t[8];const ot=R;let z;t[9]===Symbol.for("react.memo_cache_sentinel")?(z=()=>{y([]),W(!1),P("tunai")},t[9]=z):z=t[9];const X=z;let A;t[10]!==r||t[11]!==c||t[12]!==n?(A=()=>{const i=window.open("","_blank","width=400,height=600"),o=new Date,a=`POS-${o.getFullYear()+String(o.getMonth()+1).padStart(2,"0")+String(o.getDate()).padStart(2,"0")+String(o.getHours()).padStart(2,"0")+String(o.getMinutes()).padStart(2,"0")+String(o.getSeconds()).padStart(2,"0")}`;if(!i)return;const s=r.map(gt).join("");i.document.write(`
      <html>
        <head>
            <title>Struk</title>
            <style>
