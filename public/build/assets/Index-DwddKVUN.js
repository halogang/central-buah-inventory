import{c as st,u as rt,r as d,j as e,H as at}from"./app-B1R9Satc.js";import{A as nt}from"./app-layout-5qESDCVk.js";import{n as ct}from"./notify-BwFUzVz1.js";import Z from"./CartPanel-DmVb5GZW.js";import lt,{SuccessModal as dt}from"./PaymentModal-ejqZqSPA.js";import mt from"./ProductGrid-Buye8iXu.js";import pt from"./PosHistory-BdKAe_Jo.js";import{f as b}from"./format-Dvu9qd1M.js";import{S as ut}from"./shopping-cart-d5oVTPM8.js";/* empty css            */import"./index-DJaJeUwR.js";import"./loader-circle-6UOS1jWw.js";import"./createLucideIcon-DZ5txhx4.js";import"./triangle-alert-CEMkGAjR.js";import"./circle-check-nDsF0cFu.js";import"./button-F7Htwqel.js";import"./clsx-B-dksMZM.js";import"./utils-DlhoCQ_R.js";import"./index-BLc5K29S.js";import"./x-ClnMo6Be.js";import"./app-logo-icon-CPCAkNH8.js";import"./index-B_e8Ugpt.js";import"./index-CSEUMRIG.js";import"./permissions-C01--0qd.js";import"./wallet-DrIe8aX-.js";import"./log-out-Dde3Skg4.js";import"./package-DzXR5KM4.js";import"./index-2cDvttNq.js";import"./index-DTHf-B6-.js";import"./settings-FInU5Vct.js";import"./products-hCxJfRGA.js";import"./apple-DjI9N7r7.js";import"./pencil-D_qUZ4NB.js";import"./minus-C0YpEmuV.js";import"./plus-Bgs6Fos9.js";import"./trash-2-B3VEcil4.js";import"./FormSelect-CrnRxYfm.js";import"./index-BBZu3odo.js";import"./truck-CiJ79Zh1.js";import"./circle-check-big-DSzHjCZX.js";import"./printer-hudZqi7x.js";import"./use-pagination-Zf_xufG6.js";import"./search-BNtXbU7e.js";import"./image-BWpF_B5h.js";import"./search-input-BQCR9Kil.js";import"./PosDetailModal-CLfTCsrk.js";const ft=[{title:"Master Barang",href:"/items"}],le=()=>{const t=st.c(47),{productData:v,posData:S}=rt().props;let w;t[0]!==v?(w=v.map(ht),t[0]=v,t[1]=w):w=t[1];const O=w;console.log("POS Data:",S);const[Q,tt]=d.useState("");let j;t[2]===Symbol.for("react.memo_cache_sentinel")?(j=[],t[2]=j):j=t[2];const[r,y]=d.useState(j),[n,P]=d.useState("tunai"),[H,C]=d.useState(!1),[E,W]=d.useState(!1);let N;t[3]===Symbol.for("react.memo_cache_sentinel")?(N={total:0,cashReceived:0,change:0,charge:0},t[3]=N):N=t[3];const[c,et]=d.useState(N),[L,B]=d.useState(!1),[x,Y]=d.useState("pos");let k;t[4]===Symbol.for("react.memo_cache_sentinel")?(k=i=>{let o=!1;y(a=>{const s=a.find(l=>l.product.id===i.id);return s?s.qty>=i.stock?(o=!0,a):a.map(l=>l.product.id===i.id?{...l,qty:l.qty+1}:l):i.stock<=0?(o=!0,a):[...a,{product:i,qty:1,customPrice:null}]}),o&&ct.error("Stok tidak cukup!")},t[4]=k):k=t[4];const it=k;let $;t[5]===Symbol.for("react.memo_cache_sentinel")?($=(i,o)=>{y(a=>a.map(s=>{if(s.product.id!==i)return s;const l=s.qty+o;return l<1||l>s.product.stock?s:{...s,qty:l}}))},t[5]=$):$=t[5];const J=$;let _;t[6]===Symbol.for("react.memo_cache_sentinel")?(_=i=>{y(o=>o.filter(a=>a.product.id!==i))},t[6]=_):_=t[6];const U=_;let M;t[7]===Symbol.for("react.memo_cache_sentinel")?(M=(i,o)=>{y(a=>a.map(s=>s.product.id===i?{...s,customPrice:o}:s))},t[7]=M):M=t[7];const V=M;let R;t[8]===Symbol.for("react.memo_cache_sentinel")?(R=(i,o,a,s)=>{et({total:s,cashReceived:i,change:o,charge:a}),C(!1),W(!0)},t[8]=R):R=t[8];const ot=R;let z;t[9]===Symbol.for("react.memo_cache_sentinel")?(z=()=>{y([]),W(!1),P("tunai")},t[9]=z):z=t[9];const X=z;let A;t[10]!==r||t[11]!==c||t[12]!==n?(A=()=>{const i=window.open("","_blank","width=400,height=600"),o=new Date,a=`POS-${o.getFullYear()+String(o.getMonth()+1).padStart(2,"0")+String(o.getDate()).padStart(2,"0")+String(o.getHours()).padStart(2,"0")+String(o.getMinutes()).padStart(2,"0")+String(o.getSeconds()).padStart(2,"0")}`;if(!i)return;const s=r.map(gt).join("");i.document.write(`
      <html>
        <head>
            <title>Struk</title>
            <style>
