import{c as st,u as rt,r as d,j as e,H as at}from"./app-CR56X8rW.js";import{A as nt}from"./app-layout-Bwc3R-kW.js";import{n as ct}from"./notify-PTerBKTu.js";import Z from"./CartPanel-pjefXasR.js";import lt,{SuccessModal as dt}from"./PaymentModal-BsYiNKGD.js";import mt from"./ProductGrid-Dwx646Jp.js";import pt from"./PosHistory-DO7DD6q-.js";import{f as b}from"./format-Dvu9qd1M.js";import{S as ut}from"./shopping-cart-CBuu7s_B.js";/* empty css            */import"./index-tEqpCfiB.js";import"./loader-circle-DwXi9dWp.js";import"./createLucideIcon-BRgV-XVR.js";import"./triangle-alert-KzAWG82V.js";import"./circle-check-h9rs-4-X.js";import"./button-Cz5eGjds.js";import"./clsx-B-dksMZM.js";import"./utils-DlhoCQ_R.js";import"./index-CpwwdDXv.js";import"./x-CEv8pzPK.js";import"./app-logo-icon-DZaM3PLD.js";import"./index-B_e8Ugpt.js";import"./index-CSEUMRIG.js";import"./permissions-DQPbkivw.js";import"./wallet-BsCW8fO9.js";import"./log-out-CBI4sOM-.js";import"./package-B3uiWqWq.js";import"./index-CQTk5-Lh.js";import"./index-WuOBQgK8.js";import"./settings-B_KeOzb2.js";import"./products-hCxJfRGA.js";import"./apple-B5IWUSJY.js";import"./pencil-BGDioeJc.js";import"./minus-pstpWUX8.js";import"./plus-DhzlDKc2.js";import"./trash-2-8CjslQ00.js";import"./FormSelect-DUJTXq9f.js";import"./index-Dzx8-jM9.js";import"./truck-BuD1P2gn.js";import"./circle-check-big-D9d1SZbE.js";import"./printer-CqeIbW_t.js";import"./use-pagination-C80aAa-a.js";import"./search-ZAHZuQW4.js";import"./image-DC2ldtHC.js";import"./search-input-CmbOXmmO.js";import"./PosDetailModal-EAUGFnG9.js";const ft=[{title:"Master Barang",href:"/items"}],le=()=>{const t=st.c(47),{productData:v,posData:S}=rt().props;let w;t[0]!==v?(w=v.map(ht),t[0]=v,t[1]=w):w=t[1];const O=w;console.log("POS Data:",S);const[Q,tt]=d.useState("");let j;t[2]===Symbol.for("react.memo_cache_sentinel")?(j=[],t[2]=j):j=t[2];const[r,y]=d.useState(j),[n,P]=d.useState("tunai"),[H,C]=d.useState(!1),[E,W]=d.useState(!1);let N;t[3]===Symbol.for("react.memo_cache_sentinel")?(N={total:0,cashReceived:0,change:0,charge:0},t[3]=N):N=t[3];const[c,et]=d.useState(N),[L,B]=d.useState(!1),[x,Y]=d.useState("pos");let k;t[4]===Symbol.for("react.memo_cache_sentinel")?(k=i=>{let o=!1;y(a=>{const s=a.find(l=>l.product.id===i.id);return s?s.qty>=i.stock?(o=!0,a):a.map(l=>l.product.id===i.id?{...l,qty:l.qty+1}:l):i.stock<=0?(o=!0,a):[...a,{product:i,qty:1,customPrice:null}]}),o&&ct.error("Stok tidak cukup!")},t[4]=k):k=t[4];const it=k;let $;t[5]===Symbol.for("react.memo_cache_sentinel")?($=(i,o)=>{y(a=>a.map(s=>{if(s.product.id!==i)return s;const l=s.qty+o;return l<1||l>s.product.stock?s:{...s,qty:l}}))},t[5]=$):$=t[5];const J=$;let _;t[6]===Symbol.for("react.memo_cache_sentinel")?(_=i=>{y(o=>o.filter(a=>a.product.id!==i))},t[6]=_):_=t[6];const U=_;let M;t[7]===Symbol.for("react.memo_cache_sentinel")?(M=(i,o)=>{y(a=>a.map(s=>s.product.id===i?{...s,customPrice:o}:s))},t[7]=M):M=t[7];const V=M;let R;t[8]===Symbol.for("react.memo_cache_sentinel")?(R=(i,o,a,s)=>{et({total:s,cashReceived:i,change:o,charge:a}),C(!1),W(!0)},t[8]=R):R=t[8];const ot=R;let z;t[9]===Symbol.for("react.memo_cache_sentinel")?(z=()=>{y([]),W(!1),P("tunai")},t[9]=z):z=t[9];const X=z;let A;t[10]!==r||t[11]!==c||t[12]!==n?(A=()=>{const i=window.open("","_blank","width=400,height=600"),o=new Date,a=`POS-${o.getFullYear()+String(o.getMonth()+1).padStart(2,"0")+String(o.getDate()).padStart(2,"0")+String(o.getHours()).padStart(2,"0")+String(o.getMinutes()).padStart(2,"0")+String(o.getSeconds()).padStart(2,"0")}`;if(!i)return;const s=r.map(gt).join("");i.document.write(`
      <html>
        <head>
            <title>Struk</title>
            <style>
