import{c as st,u as rt,r as d,j as e,H as at}from"./app-CMvEAvZ0.js";import{A as nt}from"./app-layout-BxpixhrF.js";import{n as ct}from"./notify-D-K1JuON.js";import Z from"./CartPanel-HNKrKT5V.js";import lt,{SuccessModal as dt}from"./PaymentModal-D15FnkP6.js";import mt from"./ProductGrid-BCEFGiZm.js";import pt from"./PosHistory-qa5BzvMu.js";import{f as b}from"./format-Dvu9qd1M.js";import{S as ut}from"./shopping-cart-CXyLXKhT.js";/* empty css            */import"./index-BRH3D8g9.js";import"./loader-circle-C3KCNd_K.js";import"./createLucideIcon-B7pWWOnx.js";import"./triangle-alert-Gs8yza_g.js";import"./circle-check-D3nd37C2.js";import"./button-BBC185La.js";import"./clsx-B-dksMZM.js";import"./utils-DlhoCQ_R.js";import"./index-BsXvYP_X.js";import"./x-RaABWx4f.js";import"./app-logo-icon-Z6NXqMcG.js";import"./index-B_e8Ugpt.js";import"./index-CSEUMRIG.js";import"./permissions-CodSQgrO.js";import"./wallet-vATSqD4A.js";import"./log-out-Bok7vra-.js";import"./package-Bg0BJOI8.js";import"./index-ijNpR8Gz.js";import"./index-C6xLOmYp.js";import"./settings-CjmLJNqJ.js";import"./products-hCxJfRGA.js";import"./apple-DkjqM9GZ.js";import"./pencil-WfTcBBog.js";import"./minus-B85a-0Mp.js";import"./plus-BWPgoMGc.js";import"./trash-2-BcShdhpQ.js";import"./FormSelect-fJ9t5nAm.js";import"./index-CFHZljrL.js";import"./truck-JJIHSV8t.js";import"./circle-check-big-Bp9PWpI7.js";import"./printer-HPMnjc6o.js";import"./use-pagination-BMYUsCOa.js";import"./search-_fQ0J-oC.js";import"./image-Cesbm-6W.js";import"./search-input-BTRtKlbU.js";import"./PosDetailModal-oe7_bCO7.js";const ft=[{title:"Master Barang",href:"/items"}],le=()=>{const t=st.c(47),{productData:v,posData:S}=rt().props;let w;t[0]!==v?(w=v.map(ht),t[0]=v,t[1]=w):w=t[1];const O=w;console.log("POS Data:",S);const[Q,tt]=d.useState("");let j;t[2]===Symbol.for("react.memo_cache_sentinel")?(j=[],t[2]=j):j=t[2];const[r,y]=d.useState(j),[n,P]=d.useState("tunai"),[H,C]=d.useState(!1),[E,W]=d.useState(!1);let N;t[3]===Symbol.for("react.memo_cache_sentinel")?(N={total:0,cashReceived:0,change:0,charge:0},t[3]=N):N=t[3];const[c,et]=d.useState(N),[L,B]=d.useState(!1),[x,Y]=d.useState("pos");let k;t[4]===Symbol.for("react.memo_cache_sentinel")?(k=i=>{let o=!1;y(a=>{const s=a.find(l=>l.product.id===i.id);return s?s.qty>=i.stock?(o=!0,a):a.map(l=>l.product.id===i.id?{...l,qty:l.qty+1}:l):i.stock<=0?(o=!0,a):[...a,{product:i,qty:1,customPrice:null}]}),o&&ct.error("Stok tidak cukup!")},t[4]=k):k=t[4];const it=k;let $;t[5]===Symbol.for("react.memo_cache_sentinel")?($=(i,o)=>{y(a=>a.map(s=>{if(s.product.id!==i)return s;const l=s.qty+o;return l<1||l>s.product.stock?s:{...s,qty:l}}))},t[5]=$):$=t[5];const J=$;let _;t[6]===Symbol.for("react.memo_cache_sentinel")?(_=i=>{y(o=>o.filter(a=>a.product.id!==i))},t[6]=_):_=t[6];const U=_;let M;t[7]===Symbol.for("react.memo_cache_sentinel")?(M=(i,o)=>{y(a=>a.map(s=>s.product.id===i?{...s,customPrice:o}:s))},t[7]=M):M=t[7];const V=M;let R;t[8]===Symbol.for("react.memo_cache_sentinel")?(R=(i,o,a,s)=>{et({total:s,cashReceived:i,change:o,charge:a}),C(!1),W(!0)},t[8]=R):R=t[8];const ot=R;let z;t[9]===Symbol.for("react.memo_cache_sentinel")?(z=()=>{y([]),W(!1),P("tunai")},t[9]=z):z=t[9];const X=z;let A;t[10]!==r||t[11]!==c||t[12]!==n?(A=()=>{const i=window.open("","_blank","width=400,height=600"),o=new Date,a=`POS-${o.getFullYear()+String(o.getMonth()+1).padStart(2,"0")+String(o.getDate()).padStart(2,"0")+String(o.getHours()).padStart(2,"0")+String(o.getMinutes()).padStart(2,"0")+String(o.getSeconds()).padStart(2,"0")}`;if(!i)return;const s=r.map(gt).join("");i.document.write(`
      <html>
        <head>
            <title>Struk</title>
            <style>
