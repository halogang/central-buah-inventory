import{c as st,u as rt,r as d,j as e,H as at}from"./app-DSdogKKo.js";import{A as nt}from"./app-layout-CiFJG7tK.js";import{n as ct}from"./notify-nsCHJX8M.js";import Z from"./CartPanel-C4RQnle2.js";import lt,{SuccessModal as dt}from"./PaymentModal-LjtsoUS1.js";import mt from"./ProductGrid-a5ECEQEJ.js";import pt from"./PosHistory--JnFpAxo.js";import{f as K}from"./format-Dvu9qd1M.js";import{S as ut}from"./shopping-cart-C1HliPhZ.js";/* empty css            */import"./index-rL2bidLU.js";import"./loader-circle-pZCMX_Rn.js";import"./createLucideIcon-DWbAPuHl.js";import"./triangle-alert-BnoENhrM.js";import"./circle-check-CqZ-LOy9.js";import"./button-ChjVPaLr.js";import"./clsx-B-dksMZM.js";import"./utils-DlhoCQ_R.js";import"./index-BmRm69Xq.js";import"./x-B2E9NAgo.js";import"./app-logo-icon-DWSsngbR.js";import"./index-B_e8Ugpt.js";import"./index-CSEUMRIG.js";import"./permissions-IU1lOPwm.js";import"./wallet-D3Xdchgy.js";import"./log-out-hs2zTXmQ.js";import"./package-CXhQP-cF.js";import"./index-CANSvJlK.js";import"./index-B0Le4BGa.js";import"./settings-CWhPsgfP.js";import"./products-hCxJfRGA.js";import"./apple-Daha-8N9.js";import"./pencil-BDcAIeTm.js";import"./minus-rthuPjh4.js";import"./plus-B2BIP6Le.js";import"./trash-2-CJneiS2x.js";import"./FormSelect-urCtfOZt.js";import"./index-C7pPC8-6.js";import"./truck-B4Xa1gZq.js";import"./circle-check-big-BjwDPrav.js";import"./printer-CvOhARCT.js";import"./use-pagination-Cq7-Jv98.js";import"./search-CON36NiF.js";import"./image-CeMcD2YW.js";import"./search-input-BCzSsi49.js";import"./PosDetailModal-TxSLZXaR.js";const ft=[{title:"Master Barang",href:"/items"}],le=()=>{const t=st.c(47),{productData:v,posData:b}=rt().props;let S;t[0]!==v?(S=v.map(ht),t[0]=v,t[1]=S):S=t[1];const O=S;console.log("POS Data:",b);const[Q,tt]=d.useState("");let w;t[2]===Symbol.for("react.memo_cache_sentinel")?(w=[],t[2]=w):w=t[2];const[r,y]=d.useState(w),[n,j]=d.useState("tunai"),[H,P]=d.useState(!1),[L,W]=d.useState(!1);let C;t[3]===Symbol.for("react.memo_cache_sentinel")?(C={total:0,cashReceived:0,change:0,charge:0},t[3]=C):C=t[3];const[c,et]=d.useState(C),[E,I]=d.useState(!1),[x,Y]=d.useState("pos");let N;t[4]===Symbol.for("react.memo_cache_sentinel")?(N=i=>{let o=!1;y(a=>{const s=a.find(l=>l.product.id===i.id);return s?s.qty>=i.stock?(o=!0,a):a.map(l=>l.product.id===i.id?{...l,qty:l.qty+1}:l):i.stock<=0?(o=!0,a):[...a,{product:i,qty:1,customPrice:null}]}),o&&ct.error("Stok tidak cukup!")},t[4]=N):N=t[4];const it=N;let k;t[5]===Symbol.for("react.memo_cache_sentinel")?(k=(i,o)=>{y(a=>a.map(s=>{if(s.product.id!==i)return s;const l=s.qty+o;return l<1||l>s.product.stock?s:{...s,qty:l}}))},t[5]=k):k=t[5];const J=k;let $;t[6]===Symbol.for("react.memo_cache_sentinel")?($=i=>{y(o=>o.filter(a=>a.product.id!==i))},t[6]=$):$=t[6];const U=$;let _;t[7]===Symbol.for("react.memo_cache_sentinel")?(_=(i,o)=>{y(a=>a.map(s=>s.product.id===i?{...s,customPrice:o}:s))},t[7]=_):_=t[7];const V=_;let M;t[8]===Symbol.for("react.memo_cache_sentinel")?(M=(i,o,a,s)=>{et({total:s,cashReceived:i,change:o,charge:a}),P(!1),W(!0)},t[8]=M):M=t[8];const ot=M;let R;t[9]===Symbol.for("react.memo_cache_sentinel")?(R=()=>{y([]),W(!1),j("tunai")},t[9]=R):R=t[9];const X=R;let z;t[10]!==r||t[11]!==c||t[12]!==n?(z=()=>{const i=window.open("","_blank","width=400,height=600"),o=new Date,a=`POS-${o.getFullYear()+String(o.getMonth()+1).padStart(2,"0")+String(o.getDate()).padStart(2,"0")+String(o.getHours()).padStart(2,"0")+String(o.getMinutes()).padStart(2,"0")+String(o.getSeconds()).padStart(2,"0")}`;if(!i)return;const s=r.map(gt).join("");i.document.write(`
      <html>
        <head>
            <title>Struk</title>
            <style>
