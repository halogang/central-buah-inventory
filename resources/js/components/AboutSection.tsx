...
const points = [
    "Buah lokal dipetik pagi hari, tiba di toko siang hari.", "Buah import didatangkan langsung dari negara asal dengan rantai dingin terjaga" +
            ".",
    ...
    <section id="about" className="py-20 md:py-28 bg-muted/50 transition-all">
        <div className="container mx-auto px-4 max-w-6xl">
            <div className="flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="md:w-1/2">
                    <h2
                        className="font-display text-3xl md:text-4xl font-bold text-left text-foreground">
                        Tentang Central Buah Sutomo
                    </h2>
                    <p className="mt-6 text-left text-muted-foreground leading-relaxed">
                        {
                            websiteInfo.about_content || "Central Buah Sutomo adalah toko buah terdekat di Cilacap yang menyediakan berb" +
